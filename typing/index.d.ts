...
export class AddMorePopover<EventType extends EventItem = EventItem> extends React.Component<AddMorePopoverProps<EventType>, any> { }
...
export interface SchedulerProps<EventType extends EventItem = EventItem> {
    ...
    conflictOccurred?: (schedulerData: SchedulerData<EventType>, action: string, item: EventType, type: string, slotId: string, slotName: string, newStart: string, newEnd: string) => void;
    nonAgendaCellHeaderTemplateResolver?: (schedulerData: SchedulerData<EventType>, item: { time: string, nonWorkingTime: boolean }, formattedDateItems: string[], style: CSSProperties) => void;
    subtitleGetter?: (schedulerData: SchedulerData<EventType>, event: EventType) => void;
    movingEvent?: (schedulerData: SchedulerData<EventType>, slotId: string, slotName: string, newStart: string, newEnd: string, action: string, type: string, item: EventType) => void;
    slotClickedFunc?: (schedulerData: SchedulerData<EventType>, slot: ResourceEvent<EventType>) => void;
    slotItemTemplateResolver?: (
        schedulerData: SchedulerData<EventType>,
        slot: ResourceEvent<EventType>, slotClickedFunc: (schedulerData: SchedulerData<EventType>, slot: ResourceEvent<EventType>) => void,
        width: number,
        clsName: string
    ) => void;
...
export interface State<EventType extends EventItem = EventItem> {
    headerItem: HeaderItem<EventItem>;
    left: number;
    top: number;
    height: number;
}
...
export interface SchedulerDataBehaviors<EventType extends EventItem = EventItem> {
    ...
    getSummaryFunc?: (schedulerData: SchedulerData<EventType>, headerEvents: HeaderEvent<EventType>[], slotId: string, slotName: string, headerStart: string, headerEnd: string) =>
